...
machine-to-machine variant, are lesson 9.
-->
...
<DrawnAnnotation text="hex(" label="Keys come from configuration, never from source: lesson 2" :geometry="{ label: { x: 0.7494, y: 0.4038, width: 0.3000 } }" />
